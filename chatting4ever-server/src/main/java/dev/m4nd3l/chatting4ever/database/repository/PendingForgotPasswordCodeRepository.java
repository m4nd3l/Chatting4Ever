...
@Repository
public interface PendingForgotPasswordCodeRepository extends JpaRepository<PendingForgotPasswordCode, Long> {
    Optional<PendingForgotPasswordCode> findByCode(int code);
    Optional<PendingForgotPasswordCode> findByUserID(long userID);
